...
t.test(x=Suspension_Coil$PSI,mu=1500) #compare all lots sample versus population means

t.test(subset(Suspension_Coil,Manufacturing_Lot=="Lot1")$PSI,mu = 1500) #compare Lot1 sample versus population mean

t.test(subset(Suspension_Coil,Manufacturing_Lot=="Lot2")$PSI,mu = 1500) #compare Lot2 sample versus population mean

t.test(subset(Suspension_Coil,Manufacturing_Lot=="Lot3")$PSI,mu = 1500) #compare Lot3 sample versus population mean
